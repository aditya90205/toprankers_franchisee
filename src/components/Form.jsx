...
const Form = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 bg-white p-6 border-2 border-green-400 rounded-md mt-9">
      <h2 className="text-center text-xl md:text-3xl font-semibold text-blue-500">Franchisee Enquiry Form</h2>
      ...
      <div>
        ...
        >
          ...
          <option value="MeetUniversity APC - FOFO">MeetUniversity APC - FOFO</option>
          <option value="MeetUniversity APC - FOFOBS">MeetUniversity APC - FOFOBS</option>
          <option value="MeetUniversity APC - FOBO">MeetUniversity APC - FOBO</option>
      ...
      {/* Submit Button */}
      <button type="submit" className="bg-blue-400 text-white px-6 py-2 rounded-md">
        Submit
      </button>
    </form>
  );
